...
public class SparkJoinRDD {
	 ...
	 * @throws Exception
	 */
	public List<Tuple2<Integer, Tuple2<Sale, Customer>>> getListOfJoinedPairedRDD(JavaRDD<String> customerRdd, JavaRDD<String> salesRdd) throws Exception {	
	 ...
	 * @throws Exception
	 */
	public Set<Map.Entry<String, Iterable<Long>>> getSetOfJoinedPairedRDDValues(JavaRDD<String> customerRdd, JavaRDD<String> salesRdd) throws Exception {
	 ...
	 */
	private JavaPairRDD<Integer, Tuple2<Sale, Customer>> getJoinedPairRdd(JavaRDD<String> customerRdd, JavaRDD<String> salesRdd) throws Exception {			        
